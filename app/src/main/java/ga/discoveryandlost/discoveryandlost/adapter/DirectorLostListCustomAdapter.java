...
import ga.discoveryandlost.discoveryandlost.activity.LostDetailActivity;
 ...
 */
public class DirectorLostListCustomAdapter extends RecyclerView.Adapter<DirectorLostListCustomAdapter.ViewHolder> {
...
//    private SearchPatientActivity activity;
    ...
    // 생성자
    public DirectorLostListCustomAdapter(Context context, ArrayList<DalLost> list, RecyclerView recyclerView, OnAdapterSupport listener) {
...
//        this.activity = (SearchPatientActivity) activity;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.director_lost_list_custom_item,null);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.tv_brand.setText(lost.getBrand());
