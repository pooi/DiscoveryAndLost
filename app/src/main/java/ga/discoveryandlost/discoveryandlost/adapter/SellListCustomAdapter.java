...
import ga.discoveryandlost.discoveryandlost.activity.RequestSellActivity;
 ...
 */
public class SellListCustomAdapter extends RecyclerView.Adapter<SellListCustomAdapter.ViewHolder> {
...
//    private SearchPatientActivity activity;
    ...
    // 생성자
    public SellListCustomAdapter(Context context, ArrayList<DalSell> list, RecyclerView recyclerView, OnAdapterSupport listener) {
...
//        this.activity = (SearchPatientActivity) activity;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.sell_list_custom_item,null);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        final DalSell sell = list.get(position);
        final int pos = position;

        holder.tv_category.setText(sell.getLost().getCategory());
        if(sell.getLost().getBrand() != null && !sell.getLost().getBrand().isEmpty()){
            holder.tv_brand.setVisibility(View.VISIBLE);
            holder.tv_brand.setText(sell.getLost().getBrand());
        }else{
        ...
        if(sell.getLost().getTags() != null && !sell.getLost().getTags().isEmpty()){
            ...
            holder.tv_tags.setText(sell.getLost().getTags());
        }else{
            holder.tv_tags.setVisibility(View.GONE);
        }
        holder.tv_price.setText("가격 : " + sell.getPrice().toString() + "원");
        ...
        holder.cv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, RequestSellActivity.class);
...
//        });
    ...
    public final static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            tv_tags = (TextView)v.findViewById(R.id.tv_tags);
